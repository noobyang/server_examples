...
<form action="params2.action" method="POST">
    <table border="2" align="center">
        ...
        <tr>
            ...
            <td><input type="text" name="empList[0].id" value="7000"/></td>
        </tr>
        <tr>
            <td><input type="text" name="empList[1].username" value="呵呵"/></td>
            <td><input type="text" name="empList[1].id" value="7500"/></td>
        </tr>
        <tr>
            <td><input type="text" name="empList[2].username" value="班长"/></td>
            <td><input type="text" name="empList[2].id" value="8000"/></td>
        </tr>
        <tr>
            <td><input type="text" name="empList[3].username" value="键状哥"/></td>
            <td><input type="text" name="empList[3].id" value="8000"/></td>
        </tr>
        <tr>
            <td><input type="text" name="empList[4].username" value="绿同学"/></td>
            <td><input type="text" name="empList[4].id" value="9000"/></td>
        </tr>
        <tr>
